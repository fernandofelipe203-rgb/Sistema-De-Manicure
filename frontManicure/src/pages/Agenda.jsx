    ...
    function Agenda() {
      ...
      useEffect(() => {
        const dadosSalvos = localStorage.getItem('agendaModal')

        if (dadosSalvos) {
          const dados = JSON.parse(dadosSalvos)

          setEditando(dados.editando)
          setId(dados.id)
          setClienteId(dados.clienteId)
          setServicoId(dados.servicoId)
          setData(dados.data)
          setHora(dados.hora)
      ...
      function fecharModal() {
        ...
        localStorage.removeItem('agendaModal')
      }
                        ...
                        <td>
                          ...
                          <div className="acoes">
                           ...
                           <button
                             ...
                             onClick={() =>
                               setConfirmandoExclusao(agendamento.id)
                             }
                           >
                             Excluir
                           </button>
                    ...
                    <div className="confirmacao-exclusao">
                      ...
                      <div className="acoes-confirmacao">
                        ...
                        <button
                          className="botao-excluir"
                          onClick={() => {
                            removerAgendamento(confirmandoExclusao)
                  ...
                  <div className="campos">
                    ...
                    <div className="campo">
                      ...
                      <input
                        type="date"
                        value={data}
                       min={!editando ? obterDataMinima() : undefined}
                        onChange={(e) =>
